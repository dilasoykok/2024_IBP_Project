                                                    ...
                                                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                                        <div class="carousel-inner">
                                                            <div class="carousel-item active">
                                                                <img class="d-block w-100" src="{{asset('assets')}}/Admin/images/11.jpg"
                                                                     alt="First slide">
                                                            </div>
                                                            <div class="carousel-item">
                                                                <img class="d-block w-100" src="{{asset('assets')}}/Admin/images/12.jpg"
                                                                     alt="Second slide">
                                                            </div>
                                                            <div class="carousel-item">
                                                                <img class="d-block w-100" src="{{asset('assets')}}/Admin/images/13.jpg"
                                                                     alt="Third slide">
                                                            </div>
                                                            <div class="carousel-item">
                                                                <img class="d-block w-100" src="{{asset('assets')}}/Admin/images/14.jpg"
                                                                     alt="Third slide">
                                                            </div>
                                                            <div class="carousel-item">
                                                                <img class="d-block w-100" src="{{asset('assets')}}/Admin/images/15.jpg"
                                                                     alt="Third slide">
                                                            </div>
                                                            <div class="carousel-item">
                                                                <img class="d-block w-100" src="{{asset('assets')}}/Admin/images/10.jpg"
                                                                     alt="Third slide">
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <li class="d-block">
                                                                        <div class="form-check w-100">
                                                                            ...
                                                                            <div class="d-flex mt-2">
                                                                                <div class="ps-4 text-small me-3">{{$rs->created_at}}
                                                                                </div>
                                                                                <div
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="mt-3">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="d-flex">
                                                                        <img class="img-sm rounded-10"
                                                                             src="{{asset('assets')}}/Admin/images/faces/face5.jpg"
                                                                             alt="profile">
                                                                        <div class="wrapper ms-3">
